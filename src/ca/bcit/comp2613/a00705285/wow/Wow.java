package ca.bcit.comp2613.a00705285.wow;
...
public class Wow 
{
	...
	{
		System.out.println("-------------------------------------");
		System.out.println("       DISPLAY ALL ROLL CHARACTERS");
		System.out.println("-------------------------------------");
		...
		System.out.println("-------------------------------------");
		System.out.println("       REMOVE ALL ORCs FROM LIST");
		System.out.println("-------------------------------------");
	...
	{
		return  1 + rand.nextInt(84); // TODO is this right?
	}
